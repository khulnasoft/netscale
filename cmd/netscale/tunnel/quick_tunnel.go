...
const disclaimer = "Thank you for trying Khulnasoft Tunnel. Doing so, without a Khulnasoft account, is a quick way to" +
	...
	"https://developers.khulnasoft.com/khulnasoft-one/connections/connect-apps"

// RunQuickTunnel requests a tunnel from the specified service.
// We use this to power quick tunnels on trykhulnasoft.com, but the
...
func RunQuickTunnel(sc *subcommandContext) error {
	...
	sc.log.Info().Msg("Requesting new quick Tunnel on trykhulnasoft.com...")
