...
git config --global user.name "khulnasoft-warp-bot"
git config --global user.email "warp-bot@khulnasoft.com"

# bump formula pr
brew bump-formula-pr netscale --version="$VERSION" --no-browse --no-audit
