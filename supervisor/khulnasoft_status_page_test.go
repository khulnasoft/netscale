		...
		},
		{
			input: []byte(`{
				"page": {
					"id": "yh6f0r4529hb",
					"name": "Khulnasoft",
					"url": "https://www.khulnasoftstatus.com",
					"time_zone": "Etc/UTC",
					"updated_at": "2019-01-10T20:11:38.750Z"
				},
				"incidents": [
					{
						"name": "Khulnasoft API service issues",
						"status": "resolved",
						...
						"incident_updates": [
							{
								"status": "resolved",
								"body": "Khulnasoft has resolved the issue and the service have resumed normal operation.",
								...
								"affected_components": [
									{
										"code": "g4tb35rs9yw7",
										"name": "Khulnasoft customer dashboard and APIs - Khulnasoft APIs",
							...
							{
								"status": "monitoring",
								"body": "Khulnasoft has implemented a fix for this issue and is currently monitoring the results.\r\n\r\nWe will update the status once the issue is resolved.",
							...
							{
								"status": "investigating",
								"body": "Khulnasoft is investigating issues with APIs and Page Rule delays for Page Rule updates.  Khulnasoft Page Rule service delivery is unaffected and is operating normally.  Also, these issues do not affect the Khulnasoft CDN and therefore, do not impact customer websites.",
					...
					},
					{
						...
						"incident_updates": [
							{
								"status": "resolved",
								"body": "Khulnasoft has resolved the issue and Web Analytics have resumed normal operation.",
								...
								"affected_components": [
									{
										"code": "4c231tkdlpcl",
										"name": "Khulnasoft customer dashboard and APIs - Analytics",
										"old_status": "degraded_performance",
										"new_status": "operational"
									}
								],
							...
							{
								"status": "investigating",
								"body": "There is a delay in processing Khulnasoft Web Analytics. This affects timely delivery of customer data.\n\nThese delays do not impact analytics for DNS and Rate Limiting.",
...
func TestIncidentURL(t *testing.T) {
	...
	assert.Equal(t, "https://www.khulnasoftstatus.com/incidents/s6k0dnn5347b", incident.URL())
}
