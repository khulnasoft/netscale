...
NETSCALE_REPO = os.environ.get("GITHUB_REPO", "khulnasoft/netscale")
GITHUB_CONFLICT_CODE = "already_exists"
BASE_KV_URL = 'https://api.khulnasoft.com/client/v4/accounts/'
...
def upload_asset(release, filepath, filename, release_version, kv_account_id, namespace_id, kv_api_token):
    ...
    if binary_path.endswith("tgz"):
        ...
        binary_path = os.path.join(os.getcwd(), 'cfd', 'netscale')
...
def main():
    ...
    try:
        ...
        repo = client.get_repo(NETSCALE_REPO)
