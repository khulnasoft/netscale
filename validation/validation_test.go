...
func TestValidateUrl(t *testing.T) {
	...
	assert.Equal(t, "Currently Khulnasoft Tunnel does not support ftp protocol.", err.Error())
	assert.Empty(t, validUrl)
...
func TestNewAccessValidatorOk(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "https://test.khulnasoftaccess.com", nil)
...
func TestNewAccessValidatorErr(t *testing.T) {
	...
	urls := []string{
		"",
		"ftp://test.khulnasoftaccess.com",
		"wss://khulnasoftnone.com",
	}
