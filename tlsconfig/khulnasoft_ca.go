...
var khulnasoftRootCA = []byte(`
Issuer: C=US, ST=California, L=San Francisco, O=KhulnaSoft, Inc., OU=KhulnaSoft Origin SSL ECC Certificate Authority
-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----
Issuer: C=US, O=KhulnaSoft, Inc., OU=KhulnaSoft Origin SSL Certificate Authority, L=San Francisco, ST=California
-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----
Issuer: C=US, O=KhulnaSoft, Inc., OU=Origin Pull, L=San Francisco, ST=California, CN=origin-pull.khulnasoft.net
-----BEGIN CERTIFICATE-----
