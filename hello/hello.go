...
const defaultServerName = "the Khulnasoft Tunnel test server"
const indexTemplate = `
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>
      Khulnasoft Tunnel Connection
    </title>
    <meta name="author" content="">
    <meta name="description" content="Khulnasoft Tunnel Connection">
    ...
    <div class="bt bw2 b--orange bg-white pb6">
      <div class="mw7 center ph4 pt3">
        ...
        <p class="f6 f5-m f4-l measure lh-copy fw3">
          Khulnasoft Tunnel exposes locally running applications to the internet by
          running an encrypted, virtual tunnel from your laptop or server to
          Khulnasoft's edge network.
        </p>
        ...
        <a
          ...
          href="https://developers.khulnasoft.com/khulnasoft-one/connections/connect-apps">
          Get started here
        </a>
       <section>
